...
<body>
    ...
    <div class="navbar show-menu">
        <div class="header-inner-content">
            ...
            <nav>
                <ul>
                    <li><a href="../html/todascategorias.html">Todas as categorias</a></li>
                    <li><a href="../html/curtos.html">Curtos</a></li>
                    <li><a href="../html/longos.html">Longo</a></li>
                    <li><a href="../html/ternos.html">Ternos</a></li>
            ...
            <div class="nav-icon-container">
                ...
                <button class="cadastroElogin"><a href="../html/login.html">Login</a></button>
            </div>
        </div>
    </div>
    <!--AQUI TERMINA O MENU -->
    <div class="caixa">
        <div class="formulario">
            <form action="../html/login.html" method="POST">
                ...
                <div class="mt-4">
                    <label>Gênero <span class="">*</span></label>
                    <div class="">
                        <label><input type="radio" name="genero" value="feminino" class="mr-1" required>
                            Feminino</label>
                ...
                <div class="mt-4">
                    <label class="">
                        Data de Nascimento <span class="">*</span>
                    </label>
                    <input type="date" name="data_nascimento" class="" required>
                </div>
                ...
                <div class="">
                    <div>
                        ...
                        <input type="text" name="ddd" class="" placeholder="DDD" required>
                    </div>
                    <div>
                        <label class="">
                            Número de Celular <span class="text-red-500">*</span>
                        </label>
                        <input type="text" name="numero_celular" placeholder="Número" required>
                    </div>
                </div>
                ...
                <div class="mt-2">
                    <label>
                        ...
                        Concordo com o uso dos meus dados para reserva e experiência no site conforme a <a href="#">
    ...
    <!-- WhatsApp Button -->
    <a href="https://wa.me/5561985555581" target="_blank">
        <img src="../imagens/wats.PNG" alt="WhatsApp"
            style="position: fixed; bottom: 120px; right: 20px; width: 120px; height: 120px;">
    </a>

    <!-- JavaScript para gerenciar a wishlist -->
    <script>
        function addToWishlist(product) {
            ...
            const item = {
                ...
                price: product.querySelector('p:nth-child(3)').textContent,
                image: product.querySelector('img').src
            };
            console.log('Tentando adicionar:', item); // Depuração
            console.log('Wishlist atual:', wishlist);

            // Verifica duplicatas pelo ID
            if (!wishlist.some(existingItem => existingItem.id === item.id)) {
                wishlist.push(item);
                localStorage.setItem('wishlist', JSON.stringify(wishlist));
                console.log('Wishlist após adição:', JSON.parse(localStorage.getItem('wishlist')));
                alert('Item adicionado à lista de desejos!');
            } else {
                console.log('Item já existe:', item);
                alert('Este item já está na lista de desejos!');
            }
        }
    </script>
