         ...
         <div class="row">
            <div class="col-md-10 offset-md-1">
               <div class="titlepage">
                  ...
                  <p>Os jogos de Xbox oferecem uma experiência diversificada e conectada, com títulos incríveis e o
                     poder do Game Pass para explorar novos mundos.
                  </p>
               </div>
            </div>
         </div>
      ...
      <div class="footer">
         ...
         <div class="copyright">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <p>NOVOS GAMES COMÉRCIO VAREJISTA DE JOGOS - CNPJ: 12.345.678/9101-12 :copyright: Todos os
                        direitos
                        direitos
