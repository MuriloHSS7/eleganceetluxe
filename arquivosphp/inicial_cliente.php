               ...
               <div class="container">
                  <div class="carousel-caption">
                     <div class="text-bg">
                        ...
                        <a class="read_more" href="produtos_cliente.php">Ver Mais</a>
                     </div>
                  </div>
               </div>
            </div>
   ...
   <div class="glasses">
      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-12">
               <a class="read_more" href="produtos_cliente.php">Mais opções</a>
            </div>
            <div class="about"></div>
         </div>
      </div>
               ...
               <div class="max_width">
                  <div class="titlepage">
                     ...
                     <p>Três amigos, cada um com uma paixão única por videogames, se conheceram durante um curso técnico
                        ...
                        novamente.</p>
                     <a class="read_more" href="sobre_cliente.php">Conheça mais</a>
                  </div>
               </div>
            </div>
         </div>
