   ...
   <div class="about">
      <div class="container">
         <div class="row d_flex">
            <div class="col-md-5">
               <figure>
                  <img src="images/imagem de fundo da ti games.jpg" alt="fundo preto para o template" />
               </figure>
            </div>
            <div class="col-md-7">
               <div class="titlepage">
                  ...
                  <p>Juntos, criaram um espaço aconchegante onde os gamers podiam não só comprar jogos e periféricos,
                     ...
                     recuperavam seus consoles favoritos, graças ao trio dedicado que fazia de tudo para manter o
                     espírito
