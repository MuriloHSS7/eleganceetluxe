...
<body>
    ...
    <div>
        <div class="page-iner-content">
            <h2 class="section title">Bem-vindo ao seu perfil!</h2>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form id="request" class="main_form2">
                                <p>Clique em carrinho para fazer a sua reserva</p><br>
                                <p></p>
                                <a href="carrinho_cliente.html">
                                    <button type="button" class="btn" style="color: inherit; text-decoration: none;">
